<!--
  [subtopic].vue - Dynamic Lesson Page (Architect Roadmap)
  ========================================================
  Displays lesson content from markdown files using @nuxt/content.
  Accessed via routes like /architect/phase-1-sdlc-and-requirements/sdlc-models/waterfall-model
  ...
  Route Parameters:
  - phase: Phase slug (e.g., "phase-1-sdlc-and-requirements")
      ...
      actions: [
        {
          ...
          onClick: () => {
            navigateTo('/certificate?roadmap=architect')
          }
        }
      ]
    })
 ...
 * Format Phase Name
 * -----------------
 * Convert slug to readable name (e.g., "phase-1-sdlc-and-requirements" -> "Phase 1: Sdlc And Requirements")
 */
 ...
 * Format Topic Name
 * -----------------
 * Convert slug to readable name (e.g., "cap-theorem-and-consistency" -> "CAP Theorem And Consistency")
 */
      ...
      <template v-else>
        ...
        <template v-else>
          ...
          >
            <UBreadcrumb
              :items="[
                { label: 'Architect', icon: 'i-lucide-home', to: '/architect' },
