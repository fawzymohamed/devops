...
- [ ] T001 Add StudySchedule interface to app/data/types.ts
- [ ] T002 Extend RoadmapProgress interface with optional schedule field in app/data/types.ts
...
- [ ] T003 Create useSchedule composable skeleton in app/composables/useSchedule.ts
- [ ] T004 Implement hasSchedule() and getSchedule() functions in app/composables/useSchedule.ts
- [ ] T005 Implement setSchedule() and removeSchedule() functions in app/composables/useSchedule.ts
- [ ] T006 Implement date calculation helpers (addWeeks, calculateCompletion) in app/composables/useSchedule.ts
- [ ] T007 Implement getProjectedRoadmapCompletion() in app/composables/useSchedule.ts
- [ ] T008 Implement getProjectedPhaseCompletion() in app/composables/useSchedule.ts
- [ ] T009 Implement formatProjectedDate() helper in app/composables/useSchedule.ts
- [ ] T010 Add SSR-safe localStorage initialization in app/composables/useSchedule.ts
...
- [ ] T011 [US1] Create ScheduleSettings component skeleton in app/components/progress/ScheduleSettings.vue
- [ ] T012 [US1] Add date input field for start date in app/components/progress/ScheduleSettings.vue
- [ ] T013 [US1] Add number input (1-7) for study days per week in app/components/progress/ScheduleSettings.vue
- [ ] T014 [US1] Implement form validation (1-7 days, valid date) in app/components/progress/ScheduleSettings.vue
- [ ] T015 [US1] Connect form to useSchedule composable (setSchedule) in app/components/progress/ScheduleSettings.vue
- [ ] T016 [US1] Add "Remove Schedule" button functionality in app/components/progress/ScheduleSettings.vue
- [ ] T017 [US1] Pre-populate form with existing schedule on load in app/components/progress/ScheduleSettings.vue
- [ ] T018 [US1] Add schedule settings section to progress page in app/pages/progress.vue
- [ ] T019 [US1] Import and use useSchedule in progress page in app/pages/progress.vue
- [ ] T020 [US1] Style ScheduleSettings with Nuxt UI components (UCard, UInput, UButton) in app/components/progress/ScheduleSettings.vue
...
- [ ] T021 [US2] Add projected completion display to progress overview card in app/pages/progress.vue
- [ ] T022 [US2] Calculate and display roadmap completion date using useSchedule in app/pages/progress.vue
- [ ] T023 [US2] Conditionally show completion date OR default stats based on hasSchedule in app/pages/progress.vue
- [ ] T024 [US2] Format date display with formatProjectedDate helper in app/pages/progress.vue
- [ ] T025 [US2] Add visual styling for projected date (icon, badge) in app/pages/progress.vue
...
- [ ] T026 [US3] Add projectedDate optional prop to PhaseCard in app/components/PhaseCard.vue
- [ ] T027 [US3] Update PhaseCard badge to show date when projectedDate provided in app/components/PhaseCard.vue
- [ ] T028 [US3] Keep duration badge as fallback when no projectedDate in app/components/PhaseCard.vue
- [ ] T029 [US3] Calculate phase completion dates in roadmap pages using useSchedule
- [ ] T030 [US3] Pass projectedDate to PhaseCard components in app/pages/index.vue (DevOps)
- [ ] T031 [US3] Pass projectedDate to PhaseCard components in app/pages/fullstack/index.vue (Full Stack)
- [ ] T032 [US3] Import and use useSchedule in roadmap index pages
...
- [ ] T033 [US4] Update RoadmapTimeline to check hasSchedule and show dates in app/components/RoadmapTimeline.vue
- [ ] T034 [US4] Ensure consistent date display across all roadmap views
- [ ] T035 [US4] Test edge case: removing schedule reverts to duration labels
- [ ] T036 [US4] Add visual distinction between date display and duration display (different icon)
...
- [ ] T037 [P] Handle 0 topics edge case (display "Already complete") in useSchedule
- [ ] T038 [P] Handle 7 days/week schedule (no weekly boundary issues)
- [ ] T039 [P] Test localStorage cleared scenario (graceful fallback)
- [ ] T040 [P] Add cursor-pointer class to all new buttons per CLAUDE.md
- [ ] T041 Review and ensure dark mode styling consistency
- [ ] T042 Manual testing: end-to-end schedule flow on both roadmaps
